...
config = {
    ...
    'l2_max': 1,
    ## tokens id file
    'tk_train_file': r"/mnt/d/Dev/CS336/2026/assignment1-basics/data/tokens_TinyStoriesV2_train.npy",
    'tk_valid_file': r"/mnt/d/Dev/CS336/2026/assignment1-basics/data/tokens_TinyStoriesV2_valid.npy",
    ## checkpoint
    'load_ckpt_path': r'',
